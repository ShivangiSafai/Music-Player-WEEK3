      ...
      <div className="bg-black text-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form className="mt-8" onSubmit={submitHandler}>
          <div className='mb-4'>
            ...
            <input type="text" placeholder='Your name' className='auth-input' value={name}
            onChange={(e)=>setName(e.target.value)} required/>
          </div>
          <div className='mb-4'>
            <label className='block text-sm font-medium mb-1'>Email or UserName</label>
            <input type="email" placeholder='Email or Username' className='auth-input' value={email}
            onChange={(e)=>setEmail(e.target.value)} required/>
          </div>
          <div className='mb-4'>
            <label className='block text-sm font-medium mb-1'>Password</label>
            <input type="password" placeholder='Password' className='auth-input'value={password}
